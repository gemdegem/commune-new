          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center">
            <div className=" w-auto sm:w-[710px] sm:h-[250px] ">
              ...
              <div className="hidden sm:block">
                <p className="hero__subtitle text-xl sm:text-4xl">
                  {TAGLINE}
                  <br />
                  <span className={`hero__subtitle text-4xl ${colour[index]} font-semibold mb-5`}>{`${words[index].substring(0, subIndex)}${blink ? "|" : ""}`}</span>
                </p>
              </div>
            </div>

            <div className="w-30 h-10">
              <a href="docs/Introduction" className=" hover:no-underline">
                <div className=" bg-blue-700 rounded-lg shadow-lg hover:shadow-2xl text-center hover:bg-blue-600 duration-200 text-white hover:text-white font-sans font-semibold justify-center px-2 py-2 hover:border-blue-300 hover:border-2 hover:border-solid">Get Started</div>
              </a>
            </div>
          </div>
